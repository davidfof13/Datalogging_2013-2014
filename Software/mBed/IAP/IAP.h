...
// protect flash memory area from other usage during progam execution
...
#define     JSON_BLOCK_SIZE      256 // size of the memory in which we copy data. Can be 256 | 512 | 1024...
